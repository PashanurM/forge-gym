...
export const branches: Branch[] = [
  {
    ...
    name: "Downtown Forge",
    description:
      "Our flagship floor in the heart of Metro City—full strength hall, cycle studio, and coaching desk open late.",
  ...
  },
  {
    ...
    description:
      "Riverfront training house focused on conditioning, mobility, and recovery with floor-to-ceiling glass and open mats.",
  ...
  },
  {
    ...
    name: "West End Forge",
    description:
      "Combat-forward branch with heavy bags, functional lanes, and coaches who train fighters and everyday athletes alike.",
